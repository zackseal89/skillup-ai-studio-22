...
-- Managers can only view limited profile data through the view, not direct table access
...
-- For manager functionality, they should use the team_member_profiles view
-- which excludes email addresses and other sensitive data
-- This way managers can see team members but not harvest email addresses
